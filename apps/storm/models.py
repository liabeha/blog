...
class Article(models.Model):
    ...
    # content = UEditorField(verbose_name = '内容详情', width = 750, height = 300, imagePath = settings.MEDIA_URL,
    #                        filePath = settings.MEDIA_URL, default = '')  # imagePath和filePath 为文件上传路径
